...
{
    public abstract class CppBlockScope<T> : BlockScope where T : CppBlockScope<T>
    {

        protected CppBlockScope(string value, List<object> parameters, IProgrammingLanguageSettings languageSettings, Scope parent, IndentationManager indentLevel, List<string> codeLines)
