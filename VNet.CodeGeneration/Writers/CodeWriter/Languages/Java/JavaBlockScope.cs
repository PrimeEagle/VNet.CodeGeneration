...
{
    public abstract class JavaBlockScope<T> : BlockScope where T : JavaBlockScope<T>
    {

        protected JavaBlockScope(string value, List<object> parameters, IProgrammingLanguageSettings languageSettings, Scope parent, IndentationManager indentLevel, List<string> codeLines)
