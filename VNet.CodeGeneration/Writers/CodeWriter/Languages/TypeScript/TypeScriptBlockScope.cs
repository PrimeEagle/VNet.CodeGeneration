...
namespace VNet.CodeGeneration.Writers.CodeWriter.Languages.TypeScript
{
    public abstract class TypeScriptBlockScope<T> : BlockScope where T : TypeScriptBlockScope<T>
    {
        ...
        protected TypeScriptBlockScope(string value, List<object> parameters, IProgrammingLanguageSettings languageSettings, Scope parent, IndentationManager indentLevel, List<string> codeLines)
